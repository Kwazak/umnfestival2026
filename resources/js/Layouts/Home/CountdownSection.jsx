...
export default function CountdownSection() {
    ...
    if (loading) {
        return (
            <div className="relative flex justify-center px-4 lg:pt-36 lg:pb-24 h-screen items-center bg-gray-200">
                <div className="text-center">
                    <div className="text-lg text-gray-600">Loading countdown...</div>
                </div>
            </div>
        );
    }
    ...
    if (!event) {
        return (
            <div className="relative flex justify-center px-4 lg:pt-36 lg:pb-24 h-screen items-center bg-gray-200">
                <div className="text-center">
                    <div className="text-lg text-gray-600">No countdown events available</div>
                </div>
            </div>
        );
    }
    ...
    return (
        <div
            className="relative flex justify-center px-4 lg:pt-36 lg:pb-24 h-screen items-center"
            style={{ backgroundColor: event.bgColor || '#42B5B5' }}
        >
            <img
                src={map1}
                className="
